...
var login = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(_ref) {
    var email, password, res, _error$response$data;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 8:
            ...
            (0, _alerts.showAlert)('error', ((_error$response$data = _context.t0.response.data) === null || _error$response$data === void 0 ? void 0 : _error$response$data.message) || _context.t0.message);
...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiYm9oZGFubCIsImEiOiJjbDNyZGRid2UxZTRhM2RsMnNrOTdzam10In0.v_qjaltxgXaW5pGgDnZr0Q'; // @ts-ignore
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            url = type === 'password' ? 'http://localhost:8000/api/v1/users/updatePassword' : 'http://localhost:8000/api/v1/users/updateMe'; // @ts-ignore
...
var stripe = Stripe('pk_test_51L9nQvJLRd1BUR5iEMhCK3eOfJY4DDK8HlgmNVPc1KD5JTmP5x813UF0KA1MAabKuUEIJiLLnCwLTqduQicEzNk900UrqNdxWD');

var bookTour = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(tourId) {
    var session, _e$response$data;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 8:
            ...
            (0, _alerts.showAlert)('error', ((_e$response$data = _context.t0.response.data) === null || _e$response$data === void 0 ? void 0 : _e$response$data.message) || _context.t0.message);
...
if (loginForm) {
  loginForm.addEventListener('submit', function (e) {
    ...
    var email = document.getElementById('email').value; // @ts-ignore
...
if (passwordForm) {
  passwordForm.addEventListener('submit', /*#__PURE__*/function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(e) {
      var curPassword, newPasswordConfirm, newPassword;
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              e.preventDefault();
              document.getElementById('btn--save-password').textContent = 'Updating...'; // @ts-ignore

              curPassword = document.getElementById('password-current').value;
              newPasswordConfirm = // @ts-ignore
              document.getElementById('password-confirm').value; // @ts-ignore
            ...
            case 7:
              document.getElementById('btn--save-password').textContent = 'Save password'; // @ts-ignore

              document.getElementById('password-current').value = ''; // @ts-ignore
